...
type MemberAttempt struct {
	...
	BucketId                      *int32            `json:"bucket_id" db:"bucket_id"`
	BlockAllMemberNumbersFromList bool              `json:"block_all_member_numbers_from_list" db:"block_all_member_numbers_from_list"`
}
