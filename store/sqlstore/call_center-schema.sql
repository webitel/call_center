...
BEGIN
  ...
  raise warning '%s = %s', new.agent_id, new.state;
...
CREATE TRIGGER ts_insert_blocker BEFORE INSERT ON call_center.cc_agent_status_log FOR EACH ROW EXECUTE FUNCTION _timescaledb_functions.insert_blocker();
