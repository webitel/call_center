...
require (
	buf.build/gen/go/webitel/cc/grpc/go v1.5.1-20250220080817-337dbf2ba82b.2
...
require (
	...
	buf.build/gen/go/webitel/chat/grpc/go v1.5.1-20250205144922-f80b8cb6a2bd.2 // indirect
	buf.build/gen/go/webitel/chat/protocolbuffers/go v1.36.4-20250205144922-f80b8cb6a2bd.1 // indirect
	buf.build/gen/go/webitel/engine/protocolbuffers/go v1.36.5-20250214074617-9f276b575b99.1 // indirect
